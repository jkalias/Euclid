...
extension CodingTests {
    ...
    static let __allTests__CodingTests = [
        ...
        ("testDecodingKeyedPlane_", testDecodingKeyedPlane_),
        ...
        ("testDecodingUnkeyedPlane_", testDecodingUnkeyedPlane_),
        ...
        ("testEncodingPlane_", testEncodingPlane_),
...
extension LineSegmentTests_ {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__LineSegmentTests_ = [
        ("testConstructorEqualPoints", testConstructorEqualPoints),
        ("testDirection", testDirection),
        ("testIntersection", testIntersection),
        ("testIntersectionOnEnd", testIntersectionOnEnd),
        ("testIntersectionOnLegalBoundsButOnDifferentPlanes", testIntersectionOnLegalBoundsButOnDifferentPlanes),
        ("testIntersectionOnStart", testIntersectionOnStart),
        ("testIntersectionOutsideOfLegalBounds", testIntersectionOutsideOfLegalBounds),
    ]
}
...
extension PlaneTests_ {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__PlaneTests_ = [
        ("testContainsPoint", testContainsPoint),
        ("testDistanceFromOrigin", testDistanceFromOrigin),
        ("testDistanceFromPointPlaneThroughOrigin", testDistanceFromPointPlaneThroughOrigin),
        ("testDistanceFromPointWithOffsetFromOrigin", testDistanceFromPointWithOffsetFromOrigin),
        ("testDistanceXYPlane", testDistanceXYPlane),
        ("testDistanceXZPlane", testDistanceXZPlane),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(LineSegmentTests_.__allTests__LineSegmentTests_),
        testCase(LineTests.__allTests__LineTests),
        testCase(LineTests_.__allTests__LineTests_),
        testCase(PathTests.__allTests__PathTests),
        testCase(PlaneTests.__allTests__PlaneTests),
        testCase(PlaneTests_.__allTests__PlaneTests_),
